...
<head>
	...
	<!-- Title -->
	<title> Login - <?= $nama_perusahaan; ?></title>

	<!-- Favicon -->
	<link rel="icon" href="<?php echo base_url('logo/' . $logo) ?>" type="image/x-icon" />
				...
				<div class="col-md-6 col-lg-6 col-xl-7 d-none d-md-flex bg-warning-transparent">
					<div class="row wd-100p mx-auto text-center">
						<div class="col-md-12 col-lg-12 col-xl-12 my-auto mx-auto wd-100p">
							<img src="<?php echo base_url('logo/' . $logo) ?>" class="my-auto ht-xl-80p wd-md-100p wd-xl-80p mx-auto" alt="logo">
						</div>
					</div>
				</div>
				<!-- The content half -->
								...
								<div class="col-md-10 col-lg-10 col-xl-9 mx-auto">
									<div class="card-sigin">
										<div class="mb-5 d-flex">
											<a href="index.html"><img src="<?php echo base_url('logo/' . $logo) ?>" class="sign-favicon-a ht-80" alt="logo">
												<img src="<?php echo base_url('logo/' . $logo) ?>" class="sign-favicon-b ht-40" alt="logo">
											</a>
